...
baixo e topo, esvazia o baralho original, e reinsere as 2 partes em ordem invertida (topo vira baixo, e baixo vira topo)
*/
void Baralho::cortar(){
...
Carta Baralho::tirarCarta(){
    int cartabaixo = cartas.size() -1;
    Carta carta = cartas.at(cartabaixo);
